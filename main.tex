...
In the case of conductors, incident light may be converted into heat.
...
\end{align*}
In our case, we will make the assumption that the metal is surrounded by air, so \(n_1 = 1\).
